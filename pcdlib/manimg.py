...
# ├── equalization_grayscale()
# ├── equalization_rgb()
# ├── specification_gray_to_gray()
# ├── specification_gray_to_rgb()
# ├── specification_rgb_to_gray()
# └── specification_rgb_to_rgb()
#
# THRESHOLDING
# └── threshold()
#
# MASKING
# ├── masking_gray_to_gray()
# ├── masking_gray_to_rgb_gray_result()
# ├── masking_gray_to_rgb_rgb_result()
# ├── change_bg_gb()
# └── masking_gb()
#
...
def merge_rgb_channel(red, green, blue):

    # cek ukuran harus sama
    if red.shape != green.shape or red.shape != blue.shape:
        raise ValueError("Ukuran channel harus sama")

    # ambil tinggi dan lebar
    h, w = red.shape

    # buat array kosong 3 channel
